...
class UsersSeeder extends Seeder
{
    ...
    {
        $data = [
            ['name' => 'Admin','email' => 'admin@admin.com','role' => 'admin','phoneNumber' => '+48123213456','password'=>Hash::make("admin")],
            ['name' => 'Konradix','email' => 'konradbieniasz@dentist.com','role' => 'user','phoneNumber' => '+48123213422','password'=>Hash::make("Password123!")],
            ['name' => 'PawełGaweł','email' => 'pawełgaweł.dentist','role' => 'user','phoneNumber' => '+48987654321','password'=>Hash::make("Password123!")],
